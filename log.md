...
**Today's Progress**: Learning reactJs, about lists and keys(@keys always/should have a unique identifier)
...
**Today's Progress**: I can now edit my post 
...
**Today's Progress**: I can now add comments on posts.
**Thoughts**: learning by building a frog
...
**Today's Progress**: I can now edit and update my comments  
**Thoughts**: Learning by building a frog
...
**Today's Progress**: account is now connected with its comment
...
**Today's Progress**: fixed the bug on my username validation, i now have a session id fixed some bugs as well 
**Thoughts**: learning by doing
...
**Today's Progress**: fixed comment feature, some new issues found, and my code for that problem does not work 
**Thoughts**: learning by doing
...
**Today's Progress**: created a simple login feature for the site 
**Thoughts**: learning by doing
...
**Today's Progress**: edit login page, got some errors, going to rethink on how to solve the errors
**Thoughts**: learning by doing
...
**Today's Progress**: figurin out an algorithm for my website, did some trial an errors, found out about await and asnyc
**Thoughts**: learning by doing
...
**Today's Progress**: did some algorithm challenge
**Thoughts**: learning by doing
